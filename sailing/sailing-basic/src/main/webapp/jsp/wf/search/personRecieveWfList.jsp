...
<script type="text/javascript">
	   ...
	   var Query= function(){
			...
			var urlTemp=document.getElementById("qware").value + "/wf/personWfSearchAction.do?step=recieveList&paginater.page=14"
...
<table border="0" cellpadding="0" cellspacing="0" class="Listing"
	...
	<tbody id='tablist'>
		<c:forEach var="item" items="${theForm.recieveList}" varStatus="status">
			<tr>
...
<div class="list_bottom">
	<c:set var="paginater.forwardUrl" value="/wf/personWfSearchAction.do?step=recieveList" scope="page" /> 
