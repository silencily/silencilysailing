...
<body class="list_body" >	
	<form name="instrument_entry" method="post" action="">
		<table width="100%" border=0 cellpadding="0" cellspacing="0" height="100%">
		   <div class="main_title"><div>数据成员管理</div></div>
		    <tr valign="top">
		        ...
		        <td> 
		            ...
		            <script type="text/javascript">
		                var arr = new Array();
		                arr[0] = [" 列表 ", "", "<c:url value = '/sm/DataMemberAction.do?step=list&paginater.page=0'/>"];
						arr[1] = [" 详细 ", "", "<c:url value = '/sm/DataMemberAction.do?step=info'/>"];
