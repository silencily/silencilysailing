<%--
    @version:$Id: selectRoleEntry.jsp,v 1.1 2010/12/10 10:56:27 silencily Exp $
		    ...
		    <tr valign="top">
		        ...
		        <td> 
		            ...
		            <script type="text/javascript">
		                var arr = new Array();
		                arr[0] = [" 角色选择 ", "", "<c:url value='/sm/RoleAction.do?step=selectRoleInfoList&paginater.page=0&parentCode='/>"];
