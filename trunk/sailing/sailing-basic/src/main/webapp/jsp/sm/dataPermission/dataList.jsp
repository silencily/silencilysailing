...
if (CurrentPage == null) {
	var CurrentPage = {};
		...
		FormUtils.post(document.forms[0], '<c:url value = "/sm/DataPermissionAction.do?step=delete&oid="/>'+ oid );
	}
...
CurrentPage.query = function() {
	...
	FormUtils.post(document.forms[0], '<c:url value="/sm/DataPermissionAction.do?step=${theForm.step}"/>');
}
...
<jsp:directive.include file="dataSearch.jspf"/>
...
<div class="list_bottom"><c:set var="paginater.forwardUrl"value="/sm/DataPermissionAction.do?step=list" scope="page" /> 
