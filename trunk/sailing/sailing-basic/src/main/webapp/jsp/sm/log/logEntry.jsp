...
<div class="main_title"> <div>系统日志管理</div></div>
<div class="main_body">
	<div id="divId_panel">
		<!-- 在这里显示选项卡-->
	</div>	
...
//定义选项卡
var arr = new Array();
arr[0] = [" 列表 ", "", "<c:url value = '/sm/logManageAction.do?step=list&paginater.page=14'/>"];
arr[1] = [" 日志清理 ", "", "<c:url value = '/sm/logManageAction.do?step=clear'/>"];
