...
TableSort.dblClick = function()
   ...
   /*
CurrentPage.selectUserForConsign= function() {			
...
<!--<div align="right"><input type="button" class="opera_confirm" name="" onclick="CurrentPage.selectUserForConsign()"/><input type="button" class="opera_cancel" name="" onclick="window.close()"/></div>-->
<!--</div>-->
<form name="form">
...
<div id="supplierQuery" style="display:none">
	<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="Detail" id="divId_flaw_search_common" style="display:">
	    ...
	    <tr>
	        ...
	        <td>
	            <search:text name="tblHrDept.deptName" oper="like" type="java.lang.String" valueDefault='${theForm}'/>
	        </td>
	    </tr>
	    	</table>
...
<div id="divId_scrollLing" class="list_scroll">
	...
	<thead>
		...
		<c:forEach var="item" items="${theForm.selectUser}" varStatus="status">
			<tr>
				<td align="center">
				<input type="radio" name="oid" onclick="FormUtils.check($('detailIdsForPrintAll'),this)" value="<c:out value="${item.id}"/>" />
				</td>
...
<div class="list_bottom"><c:set var="paginater.forwardUrl" value="/sm/userManageAction.do?step=selectInfoForConsign" scope="page" /> 
